...
<CardGroup cols={3}>
  <Card title="Campaign Insights" icon="chart-line" href="/api-reference/reporting-&-analytics/get-campaign-summary">
    Start with conversational campaign analysis and health monitoring
  </Card>
  <Card title="Export Data" icon="download" href="/api-reference/reporting/export-data">  
    Export structured data for BI tools and custom analysis
  </Card>
  <Card title="Advanced Analytics" icon="microscope" href="/api-reference/reporting/provide-outcomes">
...
<Note>
**New to programmatic advertising?** Start with [Campaign Insights](/api-reference/campaign/get-summary) for conversational analysis. 

**Building dashboards or BI integrations?** Jump to [Data Export](/api-reference/reporting/export-data) for structured data access.

**Need optimization insights?** Use [Advanced Analytics](/api-reference/reporting/provide-outcomes) for ML-powered recommendations.
</Note>
...
Ready to experience next-generation campaign reporting? [Get started with our Quick Start guide](quickstart) or dive into the [Campaign Insights tool](/api-reference/campaign/get-summary).