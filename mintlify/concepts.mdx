...
graph TD
    ...
    K --> L[Scope3 Signals<br/>Media Quality]
    K --> M[Custom Signals<br/>First-Party Data]
    K --> N[Third-Party Signals<br/>External Data]
    
    %% Optimization & Serving
    K --> O[AI Optimization<br/>Engine]
    O --> P[Inventory Selection]
    P --> Q[Ad Serving]
    
    %% Performance Loop
    Q --> R[Performance Data]
    R --> S[Analytics & Reporting]
    R --> O
    S --> A
    S --> C
    ...
    class J,K,O,P,Q executionLayer
    class L,M,N,R,S dataLayer
```
...
<Tabs>
  ...
  <Tab title="Synthetic Audiences">
    ...
    **Usage**: Group by synthetic audiences to see which AI-generated profiles perform best
  </Tab>
</Tabs>
...
<AccordionGroup>
  ...
  <Accordion title="Performance Monitoring">
    ...
    - **Regular analysis**: Use tactic analysis tools to optimize signal/synthetic audience performance  
...
graph TD
    ...
    D --> E[Identify Top Signals/Synthetic Audiences]
