...
Learn more about [Signals Agents](../integrations/signals-agents) and building [Custom Agents](../integrations/custom-signals-platform).
...
<CardGroup cols={3}>
  <Card title="Custom Signals" href="../integrations/custom-signals-platform" icon="upload">
    **Upload Your Data**
