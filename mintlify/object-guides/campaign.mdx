...
<CardGroup cols={3}>
  ...
  <Card title="ML Analytics" href="/api-reference/reporting/analyze-tactics" icon="microscope">
    **Advanced Optimization**
    ...
    Deep statistical analysis of tactic performance with actionable optimization recommendations. [See Tactic Guide](tactic) for detailed analysis.
  </Card>
</CardGroup>
...
For detailed tactic performance analysis including signal effectiveness and brand story optimization, see the [Tactic Guide](tactic) and [Signal Guide](signal).
