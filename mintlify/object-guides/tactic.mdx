...
<CardGroup cols={2}>
  <Card title="Campaign Optimization" href="/mintlify/optimization/campaigns" icon="chart-line">
    **Performance Tuning**
    
    Learn how the multi-armed bandit algorithm optimizes tactic performance.
  </Card>
  
  <Card title="Signals Guide" href="/mintlify/object-guides/signal" icon="radar">
    **Targeting Data**
