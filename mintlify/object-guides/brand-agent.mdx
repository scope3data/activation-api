...
<CardGroup cols={2}>
  <Card title="Create Brand Agent" href="/api-reference/brand-agent/create" icon="plus">
    Set up a new advertiser account with basic configuration
  </Card>
  
  <Card title="List Brand Agents" href="/api-reference/brand-agent/list" icon="list">
    View all brand agents with filtering and search options
  </Card>
  
  <Card title="Get Brand Agent" href="/api-reference/brand-agent/get" icon="eye">
    Retrieve detailed information about a specific brand agent
  </Card>
  
  <Card title="Update Brand Agent" href="/api-reference/brand-agent/update" icon="edit">
