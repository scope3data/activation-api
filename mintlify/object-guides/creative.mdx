  ...
  <Tab title="Creative Agent">
    **Use AI-powered creative generation**
    ...
    const creative = await generateCreative({
      ...
      audienceIds: ["aud_tech_enthusiasts"]       // Optional synthetic audiences
    });
    ```
...
<CardGroup cols={2}>
  ...
  <Card title="List Creatives" href="/api-reference/list_creatives" icon="list">
    `GET /creatives` - View all creatives for a brand agent
  </Card>
  
  <Card title="Update Creative" href="/api-reference/update_creative" icon="edit">
    `PUT /creatives/{id}` - Modify creative properties
  </Card>
  
  <Card title="Assign to Campaign" href="/api-reference/update_campaign" icon="link">
...
<CardGroup cols={2}>
  <Card title="Format Discovery" href="/api-reference/list_creative_formats" icon="shapes">
  ...
  <Card title="Publisher Sync" href="/api-reference/creative_sync_publishers" icon="sync">
...
<CardGroup cols={3}>
  <Card title="🚀 Quick Start" href="/mintlify/creative/quickstart" icon="rocket">
    Create your first creative in 5 minutes
  </Card>
  
  <Card title="🤖 AI Agents" href="/mintlify/creative/agents" icon="robot">
    Leverage AI for creative generation
  </Card>
  
  <Card title="📊 Performance" href="/reporting-overview" icon="chart-line">
