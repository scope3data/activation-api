...
<CardGroup cols={4}>
  ...
  <Card title="GAM + Prebid" icon="google" href="/mintlify/partners/publisher-prebid-setup">
  ...
  <Card title="Partner solutions" icon="handshake" href="/mintlify/partners/sales-agents">
  ...
  <Card title="Build your own" icon="server" href="https://adcontextprotocol.org/docs/media-buy/">
