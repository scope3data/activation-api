...
<CardGroup cols={4}>
  ...
  <Card title="GAM + Prebid" href="/partners/publisher-prebid-setup" icon="google">
  ...
  <Card title="Partner solutions" href="/partners/sales-agents" icon="handshake">
...
**👉 If your sales agent requires additional AXE setup, see the [AXE Integration guide](/partners/axe-integration).**
