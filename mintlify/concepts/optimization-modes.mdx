...
<Tip>
**Hybrid Mode** will launch in Q2 2024, offering AI-powered optimization with strategic human overrides and constraints.
</Tip>
...
<Tabs>
  <Tab title="Team Factors">
    ...
    |--------|---------------------|------------------|
    | **Programmatic Experience** | Any level | Advanced |
    | **Available Time** | Limited | Flexible |
  ...
  <Tab title="Campaign Factors">
    | Factor | Built-in Optimization | Granular Control |
    |--------|---------------------|------------------|
    | **Launch Timeline** | Urgent (hours) | Flexible (days) |
    | **Budget Size** | Any | $50K+ recommended |
    | **Complexity** | Standard goals | Unique requirements |
    | **Testing Needs** | Basic A/B | Advanced multivariate |
  </Tab>
  
  <Tab title="Business Factors">
    | Factor | Built-in Optimization | Granular Control |
    |--------|---------------------|------------------|
    | **Performance Priority** | Efficiency | Precision |
    | **Learning Goals** | Quick wins | Deep expertise |
...
- Performance data resets when switching modes
- Allow 24-48 hours for optimization to stabilize
- Consider timing switches during low-traffic periods
</Warning>
