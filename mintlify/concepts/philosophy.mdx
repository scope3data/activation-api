...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="sliders"
    href="/mintlify/optimization/scoring"
  >
    Learn advanced portfolio management
  </Card>
  <Card title="Natural Language Interface" icon="comments" href="/mintlify/features/built-for-agents">
    Set up conversational campaign management
  </Card>
  <Card title="Platform Integration" icon="link" href="/mintlify/integrations/webhooks">
    See how Scope3 integrates with your stack
  </Card>
</CardGroup>
