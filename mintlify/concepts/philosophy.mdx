...
<Tabs>
  <Tab title="Complementary Campaigns">
    ``` Traditional DSP: Performance campaigns with proven tactics Scope3
    Platform: Brand campaigns with premium inventory focus ```
  </Tab>
  <Tab title="Channel Specialization">
    ``` Traditional DSP: Search and social retargeting Scope3 Platform: CTV and
    premium display ```
  </Tab>
