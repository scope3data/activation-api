...
- **Automation** of manual creative workflows
- **Zero creative bottlenecks** in campaign deployment

<Card title="Business Impact" icon="calculator">
**Example Campaign Benefits:**
...
- **API Efficiency**: Reduces creative-related API calls significantly
...
<Step title="Phase 2: Creative Management">
**Implement creative tools** - Important for campaign performance
```bash
"Create a creative with banner and headline for Nike"
```
✅ **Recommended**: Proper creative setup improves campaign outcomes
</Step>
...
<Info>
**Architecture Note**: Creative management uses a **two-layer architecture** separating MCP orchestration from file uploads. This enables real-world enterprise workflows while maintaining conversational simplicity.
</Info>
...
<Card title="🏢 Most Common" icon="building">
...
<Card title="🎯 Asset Assembly" icon="puzzle">
**Asset ID References**
...
<Card title="🤖 Dynamic Generation" icon="robot">
...
<Accordion title="creative/create - Primary Orchestration API" icon="star">
...
- `format`: Object with type ('adcp', 'publisher', or 'creative_agent') and formatId
...
- `assemblyMethod`: One of 'publisher', 'creative_agent', or 'pre_assembled'
...
<Accordion title="creative/list - Inventory Management" icon="database">
...
<Accordion title="creative/update - Modify Existing" icon="edit">
...
- `updates.status`: One of 'draft', 'pending_review', 'active', 'paused', 'archived', or 'rejected'
...
<Accordion title="assets/add - Asset References" icon="link">
...
- `assetType`: One of 'image', 'video', 'text', 'audio', 'html', or 'native_component'
...
<Accordion title="list_creative_formats - Format Discovery" icon="search">
...
**Core Parameters:**
- `type`: One of 'adcp', 'publisher', or 'creative_agent' (optional filter)
...
<Accordion title="campaign/attach_creative - Campaign Deployment" icon="rocket">
...
<Accordion title="campaign/list_creatives - Performance Analytics" icon="chart-line">
...
<Tip>
Ready to start? Try the [Creative Quick Start](quickstart) guide to create your first creative in 5 minutes!
</Tip>