...
<CardGroup cols={2}>
  ...
  <Card title="Integration Guides" href="/guides/enterprise-developers" icon="code">
    Detailed integration patterns for different use cases
  </Card>
  ...
  <Card title="MCP Setup" href="/mcp/setup" icon="message-circle">
